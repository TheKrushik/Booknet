package com.example.booknet.presentation.fragment.list.read
...
class PageReadFragment : BaseFragment(R.layout.fragment_page_books) {
    ...
    private fun setupObservers() {
        viewModel.read.observe(viewLifecycleOwner) { list: List<Book> ->
    ...
    companion object {
        fun newInstance(): Fragment = PageReadFragment()
    }
}